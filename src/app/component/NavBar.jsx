    ...
    return(
        <div className={`flex items-center sm:h-16 h-12 border-1 border-b-gray-600 border-t-transparent border-l-transparent border-r-transparent overflow-hidden justify-between ${theme === "dark" ? "bg-black" : "bg-gray-500"}`}>
            ...
            <div className="flex pl-5 items-center">
                ...
                <p className={`sm:text-3xl text-xl ${bitcount.className}`}>CodeSpaceEd</p>
            </div>
            ...
            <div className="flex pr-5">
                <button className="btn btn-outline btn-circle w-35">Login</button>
                <label className="swap swap-rotate pr-5" onChange={toggleTheme} >
                    {/* this hidden checkbox controls the state */}
                    <input type="checkbox" className="theme-controller" value="dark" checked={theme === "dark"} readOnly />
                    {/* sun icon */}
                    <svg
                    className="swap-off w-5 h-5 fill-current hidden sm:inline-block"
                    ...
                    {/* moon icon */}
                    <svg
                        className="swap-on w-5 h-5 fill-current hidden sm:inline-block"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                    <path
